...
public class HairDresserHandler {
    ...
    public void addHairDresser(String name, String description) {
        hairDresserList.add(new HairDresser(name, 300.0, description));
    }

    public void initDressers(){
        hairDresserList.add(new HairDresser("Kalle Olsson", 300.0, "Cuts men only"));
        hairDresserList.add(new HairDresser("Anna Larsson", 300.0, "Cuts women only"));
        hairDresserList.add(new HairDresser("Sture Arnesson", 300.0, "Cuts both gender"));
    }
